...
\prettyfig{monocle}{.65}{An example of pseudotime reconstruction of nephron progenitor cells. Cells are colored by clusters inferred by Louvain-Jaccard modularity and further ordered using Monocle to compare the correlation between trajectory and cluster identity.}
\newpage
\bibliographystyle{plain}
